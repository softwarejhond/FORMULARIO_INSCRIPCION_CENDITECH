...
<body>
    <img src="img/empleabilidad_cierre.jpg" alt="banner top" class="w-100" id="headerBanner">
    <div class="container">

        <?php include("APIS/register_student/newEmpCierre.php"); ?>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="infoModalLabel">FORMULARIO DE EMPLEABILIDAD - CIERRE PROYECTO: Talento TECH.</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        ¡Felicidades! <br>
                        Desde la Unión Temporal Innova Digital nos alegra que hayas terminado a satisfacción con el proceso de formación en habilidad digitales bajo la modalidad de bootcamps del MINTIC.
                        <br>
                        El presente formulario, busca identificar el perfil de empleo con el que finalizas, tras participar en el proceso de formación y ruta de empleo del proyecto Talento TECH en a ciudad de Bogotá. Esto se da con el objetivo de desarrollar mejorar continuas de la ruta.
                    </div>
