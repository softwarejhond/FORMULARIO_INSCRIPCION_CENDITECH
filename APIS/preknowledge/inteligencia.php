...
<section class="container bg-form shadow p-3">
    <form id="evaluacionForm" class="needs-validation col-10 mx-auto" novalidate  method="POST">
        ...
        <aside class="col-md-12 content-form" style="color:#ff0074;">
            <br>
            <p><b>El siguiente cuestionario tiene como objetivo validar tu nivel actual de conocimientos en Inteligencia Artificial, con el fin de ubicarte en el nivel más adecuado dentro del Bootcamp.</b></p>
        ...
        <input type="hidden" value="4" name="idForm"> <!-- Id del formulario -->

        <?php
        $sql = "SELECT * FROM preguntas WHERE id_formulario = 4;";
