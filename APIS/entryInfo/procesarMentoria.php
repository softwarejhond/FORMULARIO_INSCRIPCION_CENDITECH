...
try {
    ...
    $query_check = "SELECT id FROM asistencias_mentorias WHERE number_id = ? AND code = ? AND fecha = ?";
    ...
    $query_insert = "INSERT INTO asistencias_mentorias (number_id, code, fecha, clases_nivelacion) VALUES (?, ?, ?, ?)";
