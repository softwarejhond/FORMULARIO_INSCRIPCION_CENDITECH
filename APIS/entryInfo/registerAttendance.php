...
if ($fecha && $curso) {
    // Verificar si la URL está registrada en la tabla qr_masterclass
    $query_url = "SELECT id, clases_equivalentes FROM qr_masterclass WHERE url = ?";
                        ...
                        <div class="card shadow-lg">
                            ...
                            <div class="card-body d-flex flex-column align-items-center justify-content-center">
                                ...
                                <div class="info-item mb-3 w-100 text-center">
                                    <label class="info-label"><i class="bi bi-book"></i> Masterclass del Bootcamp:</label>
                                ...
                                <script>
                                    document.getElementById('asistenciaForm').addEventListener('submit', function(e) {
                                        ...
                                        fetch('APIS/entryInfo/procesarAsistencia.php', {
                                                method: 'POST',
                                                body: formData
                                            })
                                            .then(response => {
                ...
                <div class="row justify-content-center">
                    <div class="col-md-6">
                        <div class="alert alert-warning text-center">
                            ...
                            <h4 class="mt-3">Masterclass no encontrada</h4>
            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="alert alert-danger text-center">
                        ...
                        <h4 class="mt-3">Masterclass inválida</h4>
                        <p>La URL de esta masterclass no está registrada.</p>
                        <hr>
            ...
            <div class="col-md-6">
                <div class="alert alert-info text-center">
                    ...
                    <small class="text-muted">
                        Ejemplo: <code>asistenciaMasterClass.php?fecha=2025-08-14&curso=492</code>
                    </small>
                </div>
            </div>
        </div>
