...
$instituciones_especiales = ['Lorena Rojas'];

if (in_array($institucion_param, $instituciones_especiales)) {
    // Mostrar todas las sedes
    $queryAllHeadquarters = "SELECT * FROM headquarters WHERE mode != 'Virtual' AND id = 48";
    ...
    // Mostrar todos los programas SOLO para la sede 'Universidad La Salle - Chapinero'
    $queryAllPrograms = "SELECT DISTINCT program FROM schedules WHERE headquarters = 'Universidad La Salle - Chapinero' AND available = 1 ORDER BY program";
